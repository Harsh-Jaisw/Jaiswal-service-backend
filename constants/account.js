module.exports = Object.freeze({
    NO_ACCOUNT:
        'Please contact to admin as your account is not created yet or either it is inactive',
    ...
    ACCOUNT_NOT_ACTIVE:
        'please register your account or provided otp is not correct',
    ...
    NEW_AND_OLD_PASSWORDS_CANNOT_BE_SAME:
        'New and Old passwords cannot be the same',
    NEW_AND_CONFIRM_PASSWORDS_DO_NOT_MATCH:
        'New and Confirm password fields do not match',
