    ...
    router.post(
        ...
        validator(Joi, {
            ...
            password: Joi.string()
                ...
                .messages({
                    'string.min':
                        'Password is too short. It must be at least {{#limit}} characters long.',
                    'string.max':
                        'Password is too long. It must not exceed {{#limit}} characters.',
                    'string.pattern.base':
            ...
            first_name: Joi.string().trim().required().messages({
                ...
                'any.required':
                    'Please enter the value for Customer first name',
            }),
